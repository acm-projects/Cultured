        ...
        <div class=" card m-2">
          ...
          <div class="card-body">
            ...
            <div class="row">
                    ...
                    <p class="card-text text-left">[number] km squared</p>
            </div>
            <div class="row">
                    <h5 class="card-text text-left pr-2 pl-4">Language:</h5>
                    <p class="card-text text-left">[words]</p>
            </div>
            <div class="row">
                    <h5 class="card-text text-left pr-2 pl-4">Currency:</h5>
                    <p class="card-text text-left">[moneys]</p>
            </div>
            <div class="row">
                    <h5 class="card-text text-left pr-2 pl-4">Religion:</h5>
                    <p class="card-text text-left">[gods]</p>
            </div>
